...
export default function CategoriesSettings() {
  ...
  const handleDelete = async () => {
    await axiosInstance.delete(`/categories/${deleteId}`, { withCredentials: true });
    ...
    >
      ...
      />
        ...
        <div className="bg-white shadow-md rounded-xl p-5 border">
          ...
          {list.length === 0 && (
            <p className="text-gray-600 text-center py-3">No categories added yet</p>
          )}
